...
TESTS=( "$RunString -np 4 $example_dir/ex-02 -ntime 256 -ml 15 -skip 0" \
        ...
        "$RunString -np 2 $example_dir/ex-02 -ntime 32 -ml 15 -print_level 1  -skip 0" \
        "$RunString -np 1 $example_dir/ex-02 -ntime 9  -ml 2  -print_level 2  -skip 1 -mc 1" \
        "$RunString -np 2 $example_dir/ex-02 -ntime 32 -ml 15 -print_level 1 -fmg -skip 0" \
