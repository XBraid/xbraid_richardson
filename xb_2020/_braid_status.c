                       ...
                       braid_Real   *wfactor)
{
   ...
   braid_Real *wfactors = _braid_StatusElt(status, wfactors);
...
braid_Int
braid_StatusGetRFactors(braid_Status status,
                        braid_Int    *npoints,
                        braid_Int    **rfactors)
{
   _braid_Grid **grids  = _braid_StatusElt(status, grids);
   ...
   *rfactors = _braid_StatusElt(status, rfactors);
   return _braid_error_flag;
}

braid_Int
braid_StatusGetTGrid(braid_Status status,
                     braid_Int    *npoints,
                     braid_Real   **tgrid)
{
   _braid_Grid **grids  = _braid_StatusElt(status, grids);
   ...
   *npoints = iupper - ilower + 1; 
   *tgrid = _braid_GridElt(grids[0], ta);
   return _braid_error_flag;
}
                       ...
                       braid_Int    *cfactor)
{
   ...
   _braid_Grid **grids  = _braid_StatusElt(status, grids);
   *cfactor = _braid_GridElt(grids[0],cfactor);
   return _braid_error_flag;
}

braid_Int 
braid_StatusGetInterval(braid_Status status,
                        braid_Int    *ilower,
                        braid_Int    *iupper,
                        braid_Int    *gupper)
{
...
braid_Int
braid_StatusSetRefine(braid_Status status,
                    braid_Int    done
                   )
{
   _braid_StatusElt(status, refine_done) = done;
   return _braid_error_flag;
}
...
ACCESSOR_FUNCTION_GET1(Access, WFactor,         Real) 
...
ACCESSOR_FUNCTION_GET1(CoarsenRef, CallingFunction, Int)
/*--------------------------------------------------------------------------
 * StepStatus Routines
 *--------------------------------------------------------------------------*/
...
ACCESSOR_FUNCTION_SET1(Step, WFactor,       Real)
...
ACCESSOR_FUNCTION_GET1(Buffer, CallingFunction, Int)

/*--------------------------------------------------------------------------
 * GlobalAccessStatus Routines
 **--------------------------------------------------------------------------*/

ACCESSOR_FUNCTION_GET2(GlobalAccess, RFactors, Int, Int*)
ACCESSOR_FUNCTION_GET2(GlobalAccess, ErrorEst, Int, Real*)
ACCESSOR_FUNCTION_GET2(GlobalAccess, TGrid,    Int, Real*)
ACCESSOR_FUNCTION_GET3(GlobalAccess, Interval, Int, Int,Int)
ACCESSOR_FUNCTION_GET1(GlobalAccess, CFactor,  Int)
ACCESSOR_FUNCTION_GET1(GlobalAccess, Iter,     Int)
ACCESSOR_FUNCTION_GET1(GlobalAccess, NRefine,  Int)
ACCESSOR_FUNCTION_GET2(GlobalAccess, RNorms,   Int, Real)
ACCESSOR_FUNCTION_SET1(GlobalAccess, Refine,     Int)
ACCESSOR_FUNCTION_SET1(GlobalAccess, RSpace,   Int)
ACCESSOR_FUNCTION_GET1(GlobalAccess, CallingFunction, Int)
